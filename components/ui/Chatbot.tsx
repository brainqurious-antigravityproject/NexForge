...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState<{ id: number; text: string; isBot: boolean; hasWhatsAppCTA?: boolean }[]>([
    { id: 1, text: "Hi there! 👋 Prefer chatting on WhatsApp?", isBot: true, hasWhatsAppCTA: true }
  ]);
