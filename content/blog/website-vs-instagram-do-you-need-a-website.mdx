...
<BlogFAQ items={[
  { q: "Can I run a business without a website?", a: "Yes, many businesses do — but you're capping your growth. You're invisible on Google, dependent on a platform you don't control, and less credible to buyers who compare options before spending." },
  { q: "Is a Facebook page enough for a small business?", a: "A Facebook page is better than nothing, but it has the same limitations as Instagram: no Google ranking, no data ownership, no control if the platform changes. It's a distribution channel, not a foundation." },
  { q: "Why is a website better than social media for business?", a: "A website is better for SEO, credibility, customer data ownership, and long-term stability. Social media is better for discovery, community, and real-time engagement. The combination is stronger than either alone." },
  { q: "How much does a simple business website cost?", a: "A professionally built one-page site typically costs less than a month of ad spend. Ongoing care — backups, updates, edits — runs around RM 100–200/month or the equivalent in INR. The cost is predictable and not tied to clicks or impressions." },
]} />
